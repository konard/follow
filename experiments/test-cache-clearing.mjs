...
const cacheFile1 = lino.saveAsLino(CACHE_FILES.VK_CHATS, rejectedChats);
...
const cache1 = lino.loadFromLino(CACHE_FILES.VK_CHATS);
...
const cacheFile2 = lino.saveAsLino(CACHE_FILES.VK_CHATS, []);
console.log(`✅ Cleared cache: ${cacheFile2}`);

// Test 4: Verify cache is empty
console.log('\nTest 4: Verifying cache is empty...');
const cache2 = lino.loadFromLino(CACHE_FILES.VK_CHATS);
